...
('Arconte de la Absolucion',2,3,1,'./img/criaturas/01.png','Criatura','Arconte',1,'Vuela. Proteccion contra blanco.
no puede ser bloqueada'
,'Las criaturas no pueden atacarte a ti o a un planeswalker','3','2','Igor Kierylek')
,('Paladin de Monteascua',3,3,1,'./img/criaturas/02.png','Criatura','Caballero',1,'El Paladin de Monteascua entra al campo de batalla con un contador +1/+1 sobre el'
,'El rey moriria por su reino yo no dudaria en hacer lo mismo por el','4','1','Randy Vargas')
...
atacante objetivo +1 fuerza','Las Hadas criaron a la tortuga desde que salio del huevo','1','5','Mielvos Ceran')
,('Filoascua',3,4,2,'./img/criaturas/04.png','Artefacto','Equipo',1,'Te cuesta 1 de mana incoloro lanzar 
este hechizo por cada criatura atacante','Sin descripcion','0','0','Joe Slucher')
,('Todo lo que reluce',2,1,1,'./img/criaturas/05.png','Encantamiento','Aura',1,'La criatura encantada obtiene +1/+1 por cada artefacto 
y/o encantamiento que controlas','La alegria de un hada al conseguir su tesoro se desvanece rapidamente','0','0','Iain McCaig')
...
,('Paladin Valle de Arden',2,3,1,'./img/criaturas/07.png','Criatura','Caballero',1,'Entra al campo de batalla con un contador +1 +1 sobre ella','Aun 
cuando la esperanza no es mas que un candil que tilila en la noche','2','5','Volkan Baga')
,('Chiquitin',1,0,1,'./img/criaturas/08.png','Encantamiento','Aura',1,'La criatura encantada obtiene 2/0','Su espada sono como un tintineo argenteo contra el 
cristal del tarro y la duende sonrio encantada','0','0','Randy Vargas')
,('Syr Elenora la Perspicaz',1,3,2,'./img/criaturas/09.png','Criatura','Caballero',1,'Cuando Syr Elenora entre al campo de batalla roba una carta','Sin descripcion','*','4','Mila Pesec')
,('Ayara de Nimboscuro',4,0,3,'./img/criaturas/10.png','Criatura','Noble elfo',1,'Cada oponente pierde 1 vida y tu ganas 1 vida.
','El luto se torna en celebracion en cuanto elige a su proximo pretendiente','2','3','Ryan Pancoast');
